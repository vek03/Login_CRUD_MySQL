...
public class frmTela extends javax.swing.JFrame {
     ...
     */
    //método construtor que irá iniciar os componentes, conectar ao banco e trazer as informações da tabela no primeiro registro
    public frmTela() {
        initComponents();
    ...
    private void tblClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClientesMouseClicked
        //ao clicar em um registro da tabela, o programa irá trazer as informações do registro para manipulação no cadastro
        //SELECT
    ...
    private void tblClientesKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblClientesKeyPressed
        //aqui, a mesma coisa acontece do que quando o mouse é clicado sobre um registro da tabela, porem, agora é o teclado que seleciona
        //SELECT
        int linha_selecionada = tblClientes.getSelectedRow();
    ...
    private void btnVoltarUmRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarUmRegistroActionPerformed
        ...
        //contém tratamento para que ele não busque um registro inexistente ao tentar voltar um registro partindo do primeiro
        //SELECT
        
        try {
            //atribuindo o numero do id que está em uso á variavel, funcionando como "linha selecionada"
            int id_selecionado = con_cliente.resultset.getInt(1);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        //este botão irá limpar os dados do registro que estava selecionada dos campos de cadastro, permitindo assim o usuário inserir informações
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        //este botão irá cadastrar os dados inseridos pelo usuário no banco, adicionando mais um registro á tabela
        //INSERT
    ...
    private void btnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitActionPerformed
        //botão que irá finalizar a execução do programa
